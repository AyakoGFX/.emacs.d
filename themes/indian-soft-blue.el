;;; indian-soft-blue-theme.el --- Theme using Template SCSS variables -*- lexical-binding: t -*-
...
(deftheme indian-soft-blue "Theme using Template variables with quality of life improvements.")
...
(let* ((bg "#131317")
      ...
      (on-primary "#212b65")
      (on-primary-container "#2c3670")
      (on-secondary "#2b2f46")
      (on-secondary-container "#b1b3d0")
      (on-surface "#e4e1e7")
      (on-surface-variant "#c6c5d1")
      (on-tertiary "#4f1c4a")
      (on-tertiary-container "#5b2755")
      (outline-color "#90909b")
      (outline-variant "#454650")
      (primary "#bac3ff")
      (primary-container "#97a1e3")
      (secondary "#c2c4e2")
      (secondary-container "#42455e")
      (shadow "#000000")
      (surface "#131317")
      ...
      (surface-variant "#454650")
      (tertiary "#f5b1e8")
      (tertiary-container "#d190c5")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#f5b1e8")
      (on-success "#4f1c4a")
      (success-container "#d190c5")
      (on-success-container "#5b2755")
      ;; Map fixed colors to regular colors
      (primary-fixed "#bac3ff")
      (primary-fixed-dim "#97a1e3")
      (secondary-fixed "#c2c4e2")
      (secondary-fixed-dim "#42455e")
      (tertiary-fixed "#f5b1e8")
      (tertiary-fixed-dim "#d190c5")
      (on-primary-fixed "#212b65")
      (on-primary-fixed-variant "#2c3670")
      (on-secondary-fixed "#2b2f46")
      (on-secondary-fixed-variant "#b1b3d0")
      (on-tertiary-fixed "#4f1c4a")
      (on-tertiary-fixed-variant "#5b2755")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#e4e1e7")
      (inverse-primary "#bac3ff")
      (inverse-surface "#131317")
...
(provide-theme 'indian-soft-blue)
;;; indian-soft-blue-theme.el ends here