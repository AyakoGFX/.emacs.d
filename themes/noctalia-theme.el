...
(let* ((bg "#12140b")
      ...
      (on-primary "#263500")
      (on-primary-container "#435a00")
      (on-secondary "#263501")
      (on-secondary-container "#acc07c")
      (on-surface "#e2e4d3")
      (on-surface-variant "#c4c9b1")
      (on-tertiary "#003918")
      (on-tertiary-container "#00602d")
      (outline-color "#8e937d")
      (outline-variant "#444937")
      (primary "#c5f35a")
      (primary-container "#aad640")
      (secondary "#bacf89")
      (secondary-container "#3e4f17")
      (shadow "#000000")
      (surface "#12140b")
      (surface-container "#1e2117")
      (surface-container-high "#282b20")
      (surface-container-highest "#33362b")
      (surface-container-low "#1a1d13")
      (surface-container-lowest "#0d0f07")
      (surface-variant "#444937")
      (tertiary "#75fd9c")
      (tertiary-container "#56e082")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#75fd9c")
      (on-success "#003918")
      (success-container "#56e082")
      (on-success-container "#00602d")
      ;; Map fixed colors to regular colors
      (primary-fixed "#c5f35a")
      (primary-fixed-dim "#aad640")
      (secondary-fixed "#bacf89")
      (secondary-fixed-dim "#3e4f17")
      (tertiary-fixed "#75fd9c")
      (tertiary-fixed-dim "#56e082")
      (on-primary-fixed "#263500")
      (on-primary-fixed-variant "#435a00")
      (on-secondary-fixed "#263501")
      (on-secondary-fixed-variant "#acc07c")
      (on-tertiary-fixed "#003918")
      (on-tertiary-fixed-variant "#00602d")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#e2e4d3")
      (inverse-primary "#c5f35a")
      (inverse-surface "#12140b")
