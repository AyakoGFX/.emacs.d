;;; indian-classy-theme.el --- Theme using Template SCSS variables -*- lexical-binding: t -*-
...
(deftheme indian-classy "Theme using Template variables with quality of life improvements.")
...
(let* ((bg "#17130b")
       ...
       (on-secondary "#3f2e04")
       (on-secondary-container "#ceb27b")
       (on-surface "#ebe1d4")
       (on-surface-variant "#d2c5af")
       (on-tertiary "#283500")
       (on-tertiary-container "#313f00")
       (outline-color "#9b8f7b")
       (outline-variant "#4f4635")
       (primary "#f4bf45")
       (primary-container "#cd9c23")
       (secondary "#e0c38b")
       ...
       (surface-variant "#4f4635")
       (tertiary "#b6d166")
       (tertiary-container "#94ae47")
       ;; Map success colors to tertiary (as used in other templates)
       (success "#b6d166")
       (on-success "#283500")
       (success-container "#94ae47")
       (on-success-container "#313f00")
       ;; Map fixed colors to regular colors
       (primary-fixed "#f4bf45")
       (primary-fixed-dim "#cd9c23")
       (secondary-fixed "#e0c38b")
       (secondary-fixed-dim "#584418")
       (tertiary-fixed "#b6d166")
       (tertiary-fixed-dim "#94ae47")
       (on-primary-fixed "#402d00")
       (on-primary-fixed-variant "#4c3600")
       (on-secondary-fixed "#3f2e04")
       (on-secondary-fixed-variant "#ceb27b")
       (on-tertiary-fixed "#283500")
       (on-tertiary-fixed-variant "#313f00")
       ;; Map inverse colors to surface variants
       (inverse-on-surface "#ebe1d4")
       (inverse-primary "#f4bf45")
       (inverse-surface "#17130b")
...
(provide-theme 'indian-classy)
;;; indian-classy-theme.el ends here
